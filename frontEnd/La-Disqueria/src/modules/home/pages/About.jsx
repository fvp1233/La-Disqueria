...
export function About() {
  return (
    <>
      {/* ── HERO ── */}
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 px-12 py-14 bg-white items-center">
        <div>
          ...
          <h1
            className="text-[52px] font-black bold leading-[1] uppercase text-[#0f172a] mb-5"
            style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
          >
            La música<br />no se<br />escucha,{" "}
            <span className="text-[#E8602A] font-black bold">se<br />siente.</span>
          </h1>
          ...
          <div className="flex gap-8">
            <div>
              ...
              <p className="text-xs text-[#333] font-black bold">Tecnología moderna V.5</p>
            </div>
            <div>
              <p className="text-[9px] font-semibold tracking-widest text-[#E8602A] uppercase mb-1">Cooperativa</p>
              <p className="text-xs text-[#333] font-black bold">Garaje model</p>
            </div>
          </div>
        </div>
...
<div className="relative p-4">
  ...
  <div className="absolute -bottom-3 -left-3 w-11 h-11 rounded-lg bg-[#E8602A] flex items-center justify-center z-10 shadow-md">
    <svg width="18" height="18" viewBox="0 0 16 16" fill="white">
      ...
      {/* ── MISIÓN / VISIÓN ── */}
      {/* ── MISIÓN / VISIÓN ── */}
<section className="grid grid-cols-1 md:grid-cols-2 gap-8 px-12 py-14 bg-[#fafafa]">
  ...
  <div className="border-l-[3px] border-[#E8602A] pl-6">
    <div className="flex items-center gap-2 mb-4">
      ...
      <p className="text-sm font-bold tracking-[2px] text-[#E8602A] uppercase">
        Nuestra Misión
      </p>
    </div>
  ...
  <div className="border-l-[3px] border-[#E8602A] pl-6">
    ...
    <p className="text-sm font-medium text-[#334155] leading-relaxed">
      ...
      <section className="px-12 py-16 bg-white text-center">
        <p className="text-[9px] tracking-[3px] text-[#E8602A] font-black bold uppercase mb-2">Quiénes somos</p>
        <h2
          className="text-[40px] font-black uppercase text-[#1a1a1a] mb-8"
          style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
        >
      ...
      {/* ── FEATURES ── */}
<section className="grid grid-cols-1 md:grid-cols-3 gap-8 px-12 py-14 bg-[#F47E6A]">
  {[
    {
      icon: iconPush,
      title: "Experiencia VS Digital",
      text: "Recuperamos la emoción de tocar un disco. El arte del vinilo es la alternativa al ruido digital. El amor por el tacto y el viaje en la vida.",
    },
    {
      icon: iconBuy,
      title: "Apoyo Escena Local",
      text: "Promovemos artistas y sellos salvadoreños, dando visibilidad a la escena musical local dentro y fuera del país.",
    },
    {
      icon: iconCheck,
      title: "Alta Curaduría",
      text: "Cada disco en nuestro catálogo pasa por un proceso de selección riguroso. Calidad sobre cantidad, siempre.",
    },
  ].map(({ icon, title, text }) => (
    <div key={title}>
      {/* Imagen con mismo tamaño que tenían los emojis */}
      <img
        src={icon}
        alt={title}
        className="w-8 h-8 object-contain mb-3"
      />
      <p className="text-[10px] font-semibold tracking-widest text-white uppercase mb-2">
        {title}
      </p>
      ...
      <section className="px-12 py-16 bg-white">
        <p className="text-[9px] tracking-[3px] text-[#E8602A] font-black bold uppercase mb-2">Nuestro Equipo</p>
        <h2
          className="text-[38px] font-black uppercase text-[#1a1a1a] mb-12"
          style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
        >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8">
          {teamMembers.map(({ name, lastName, role }) => (
            <div key={lastName} className="flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-[#eee] mb-3 flex items-center justify-center overflow-hidden">
                {/* reemplaza con <img src={fotoMiembro} /> cuando tengas las fotos */}
