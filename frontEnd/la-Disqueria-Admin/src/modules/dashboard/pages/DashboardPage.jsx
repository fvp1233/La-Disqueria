        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
              ...
              <TableBody>
                {[
                  ...
                  <TableRow key={i} className="border-none">
                    <TableCell className="py-2 px-0 text-sm font-medium text-gray-700">
                      {item.a}
                    </TableCell>
          ...
          <div className="bg-white rounded-[35px] p-6 shadow-sm border border-gray-100">
            ...
            <div className="h-28 bg-red-50/30 rounded-2xl relative overflow-hidden">
              <div
                className="absolute bottom-0 w-full h-12 bg-red-200/40"
                style={{
                  clipPath:
                    "polygon(0 100%, 0 20%, 25% 60%, 45% 15%, 70% 85%, 100% 35%, 100% 100%)",
                }}
              ></div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[35px] p-8 shadow-sm border border-gray-100 flex-grow">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="bg-[#F3F6F9] px-3 py-2 rounded-xl text-gray-400">
                  ≡
                </button>
              </div>
            </div>
              ...
              <TableBody>
                {[
                  ...
                  <TableRow key={i} className="border-b border-gray-50 last:border-none">
                    ...
                    <TableCell>
                      <span className={`${row.c} text-white px-3 py-1 rounded-xl text-xs font-bold`}>
                        {row.s}
                      </span>
                    </TableCell>
